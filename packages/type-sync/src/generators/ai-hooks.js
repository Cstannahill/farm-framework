...
export class AIHookGenerator {
    ...
    generateAIHooksContent(schema, opts) {
...
`;
    ...
    generateStreamingChatHook(opts) {
        const providers = opts.supportedProviders?.map((p) => `'${p}'`).join(" | ") ||
...
export function useTokenCounter() {
  ...
  return {
    ...
    generateCustomEndpointHook(endpoint, opts) {
